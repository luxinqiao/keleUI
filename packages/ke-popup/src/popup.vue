<template>
    <div class='kePopup shadeIn' v-if='show' ref='menu' @click='close()'>
...
export default {
    ...
    methods: {
        ...
        */
        close() {
            if (this.direction == 'up') {
                this.$refs.content.className += ' bottom-transDown'
            } else if (this.direction == 'down') {
                this.$refs.content.className += ' top-transUp'
            }
            this.$refs.menu.className += ' shadeOut'
            setTimeout(() => {
