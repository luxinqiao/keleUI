<template>
    <div class='keVideo' ref='keVideo'>
        ...
        <img class='loading' v-if='videoData.status=="loading"' :src='require("../img/loading.png")'>
        <div class='shade' v-else-if='["pause","end"].includes(videoData.status)'>
            <img :src='require("../img/pause.png")' @click='togglePlay()'>
        </div>
        <div class='control' v-if='["pause","end"].includes(videoData.status) || videoData.control'>
            ...
            <img class='fullScreen' :src='require("../img/fullScreen.png")' @click='toggleFullScreen()'>
        </div>
    </div>
</template>

<script>
    import {getAppType, debounce} from '../../utils/common.js'
    ...
    export default {
        ...
        methods: {
            ...
            enterFullscreen() {
                ...
                const video = this.$refs.video, keVideo = this.$refs.keVideo
                this.videoData.fullScreen = true
                if (this.appType == 'ios') {
                    video.webkitEnterFullscreen()
                } else {
                    if (keVideo.requestFullscreen) {
                        keVideo.requestFullscreen()
                    } else if (keVideo.mozRequestFullScreen) {
                        keVideo.mozRequestFullScreen()
                    } else if (keVideo.webkitRequestFullscreen) {
                        keVideo.webkitRequestFullscreen()
                    } else if (keVideo.msRequestFullscreen) {
                        keVideo.msRequestFullscreen()
                    }
                }
            },
            ...
            getPlayBtnIcon() {
                if (['play','loading'].includes(this.videoData.status)) {
                    return require('../img/play-bottom.png')
                } else if (['pause','end'].includes(this.videoData.status)){
                    return require('../img/pause-bottom.png')
                }
                return require('../img/pause-bottom.png')
            },
